    ...
    >
      <div className="px-4 py-4 border-b border-[#6B0000] relative">
        ...
        <div className="mt-2 text-center">
          <p className="text-white text-xs font-semibold tracking-wide">Salah Collective</p>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                isActive
                  ? 'bg-[#F4A943] text-[#8C0000]'
                  : 'text-white/80 hover:bg-[#6B0000] hover:text-white'
              }`
            }
          >
            {icon}
      ...
      <div className="px-3 py-4 border-t border-[#6B0000]">
        <button
          onClick={handleLogout}
          className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm font-medium text-white/60 hover:bg-[#6B0000] hover:text-white transition-colors"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
